...
### Opcode: `call`
#### Parameters
`* function [assoc arguments]`
#### Description
Evaluates `function` after pushing the `arguments` assoc onto the scope stack.
#### Details
 - Permissions required:  none
 - Allows concurrency: false
 - Requires entity: false
...
#### Parameters
`* function assoc arguments [number operation_limit] [number max_node_allocations] [number max_opcode_execution_depth] [bool return_warnings]`
#### Description
