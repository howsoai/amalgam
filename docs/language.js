...
*/
	...
	{
		"parameter" : "edit_distance * node1 * node2 [bool use_string_edit_distance] [assoc params]",
		"output" : "number",
		"new value" : "new",
...

	{
		...
		"output" : "*",
		"new value" : "new",
		"description" : "Evaluates to whatever is common between node1 and node2 exclusive.  The assoc params can contain the keys nominal_values and recursive_matching.  If the key nominal_values is true, the default, then it will assume that all immediate values (numbers, strings, booleans) will match only if identical; if false, it will compare similarity of values.  If the key recursive_matching is true or null, then it will attempt to recursively match any part of the data structure of node1 to node2.  If the key recursive_matching is false, then it will only attempt to merge the two at the same level, which yield better results if the data structures are common, and additionally will be much faster.",
...

	{
		...
		"permissions" : "entity",
		"new value" : "new",
		"description" : "Evaluates to the total count of all of the nodes referenced within entity1 and entity2 that are equivalent, including all contained entities.  The assoc params can contain the keys nominal_values and recursive_matching.  If the key nominal_values is true, the default, then it will assume that all immediate values (numbers, strings, booleans) will match only if identical; if false, it will compare similarity of values.  If the key recursive_matching is true or null, then it will attempt to recursively match any part of the data structure of node1 to node2.  If the key recursive_matching is false, then it will only attempt to merge the two at the same level, which yield better results if the data structures are common, and additionally will be much faster.",
...

	{
		...
		"permissions" : "entity",
		"new value" : "new",
		"description" : "Evaluates to the edit distance of all of the nodes referenced within entity1 and entity2 that are equivalent, including all contained entities.  The assoc params can contain the keys nominal_values and recursive_matching.  If the key nominal_values is true, the default, then it will assume that all immediate values (numbers, strings, booleans) will match only if identical; if false, it will compare similarity of values.  If the key recursive_matching is true or null, then it will attempt to recursively match any part of the data structure of node1 to node2.  If the key recursive_matching is false, then it will only attempt to merge the two at the same level, which yield better results if the data structures are common, and additionally will be much faster.",
