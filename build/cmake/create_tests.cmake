...
# Standalone FIFO queue/thread lifecycle regression (no interpreter dependency).
if(NOT IS_WASM)
    find_package(Threads REQUIRED)
    add_executable(thread-pool-test test/thread_pool/main.cpp src/Amalgam/ThreadPool.cpp)
    target_compile_features(thread-pool-test PRIVATE cxx_std_20)
    ...
    add_test(NAME ThreadPool.Regression COMMAND thread-pool-test)
    set_tests_properties(ThreadPool.Regression PROPERTIES TIMEOUT 30 LABELS smoke_test)
endif()
