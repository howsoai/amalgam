...
std::array<Interpreter::OpcodeFunction, ENT_NOT_A_BUILT_IN_TYPE + 1> Interpreter::_opcodes = {
	...
	&Interpreter::InterpretNode_ENT_GET_ENTITY_SYSTEM_PERMISSIONS,									// ENT_GET_ENTITY_SYSTEM_PERMISSIONS
	&Interpreter::InterpretNode_ENT_SET_ENTITY_SYSTEM_PERMISSIONS,									// ENT_SET_ENTITY_SYSTEM_PERMISSIONS
