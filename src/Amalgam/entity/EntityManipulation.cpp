...
EvaluableNodeReference EntityManipulation::DifferenceEntities(Interpreter *interpreter, Entity *entity1, Entity *entity2)
{
	...
	df_assoc->SetMappedChildNode(GetStringIdFromNodeTypeFromString(ENBISI__), nullptr);
	df_assoc->SetMappedChildNode(GetStringIdFromNodeTypeFromString(ENBISI_new_entity), nullptr);
	...
	if(IsEntityIdenticalToComparedEntity(entity2, entity2_to_merged_entity, top_entities_identical, different_entities))
	{
		...
		clone_entity->AppendOrderedChildNode(enm->AllocNode(ENT_SYMBOL, GetStringIdFromNodeTypeFromString(ENBISI__)));
		clone_entity->AppendOrderedChildNode(enm->AllocNode(ENT_SYMBOL, GetStringIdFromNodeTypeFromString(ENBISI_new_entity)));
		delete root_merged;
	...
	assign_new_entity->AppendOrderedChildNode(enm->AllocNode(ENT_STRING,
		GetStringIdFromNodeTypeFromString(ENBISI_new_entity)));
	...
	edac_assoc->SetMappedChildNode(GetStringIdFromNodeTypeFromString(ENBISI__), get_entity_code);
	get_entity_code->AppendOrderedChildNode(enm->AllocNode(ENT_SYMBOL, GetStringIdFromNodeTypeFromString(ENBISI__)));
	...
	for(auto &entity_to_create : different_entities)
	{
		...
		src_append->AppendOrderedChildNode(enm->AllocNode(ENT_SYMBOL, GetStringIdFromNodeTypeFromString(ENBISI__)));
		...
		dest_append->AppendOrderedChildNode(enm->AllocNode(ENT_SYMBOL, GetStringIdFromNodeTypeFromString(ENBISI_new_entity)));
		...
		else //need to difference
		{
			...
			call_assoc->SetMappedChildNode(GetStringIdFromNodeTypeFromString(ENBISI__), entity_code);
	...
	difference_function->AppendOrderedChildNode(enm->AllocNode(ENT_SYMBOL, GetStringIdFromNodeTypeFromString(ENBISI_new_entity)));
