...
#endif
{
	...
	nodeStackNodes = &interpreter_node_stack->GetOrderedChildNodes();
...
EvaluableNodeReference Interpreter::InterpretNode(EvaluableNode *en, bool immediate_result)
{
	...
	//CreateNodeStackStateSaver is a bit expensive for this frequently called function
	//especially because only one node is kept
	nodeStackNodes->push_back(en);
