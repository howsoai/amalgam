	...
	size_t query_feature_index, BitArrayIntegerSet &enabled_indices)
{
	...
	if(value.IsNull())
	{
		...
		else //nonsymmetric nominal -- need to compute
		{
			...
			r_dist_eval.IterateOverNominalValuesWithLessOrEqualDistanceTerms(feature_data.nominalNumberDistanceTerms,
				unknown_unknown_term, query_feature_index, high_accuracy,
			...
			r_dist_eval.IterateOverNominalValuesWithLessOrEqualDistanceTerms(feature_data.nominalStringDistanceTerms,
				unknown_unknown_term, query_feature_index, high_accuracy,
	...
	else if(feature_type == GeneralizedDistanceEvaluator::FDT_NOMINAL_STRING)
	{
		...
		r_dist_eval.IterateOverNominalValuesWithLessOrEqualDistanceTerms(feature_data.nominalStringDistanceTerms,
			accumulated_term, query_feature_index, high_accuracy,
