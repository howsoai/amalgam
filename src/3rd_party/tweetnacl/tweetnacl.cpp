...
//Need to add this to make everything work
#ifdef __cplusplus
extern "C" {
#endif
...
//modified from original due to compilation issues on some compilers
...
//need to add this to make everything work correctly
#ifdef __cplusplus
}
#endif
