...
if(DEFINED ENV{BUILD_BUILDNUMBER} AND NOT "$ENV{BUILD_BUILDNUMBER}" STREQUAL "")

    # TODO: remove this path after GitHub move
    # Defined by Azure pipeline (Build.BuildNumber)
    message(STATUS "Reading version from env var 'BUILD_BUILDNUMBER'")
    set(AMALGAM_VERSION_ORIG "$ENV{BUILD_BUILDNUMBER}")
    set(AMALGAM_VERSION "${AMALGAM_VERSION_ORIG}")

elseif(DEFINED ENV{AMALGAM_BUILD_VERSION} AND NOT "$ENV{AMALGAM_BUILD_VERSION}" STREQUAL "")
