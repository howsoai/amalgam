...
function(add_compiled_target)
    ...
    elseif(AUTO_NAME)
        ...
        if(USE_THREADS AND NOT USE_OPENMP)
            string(APPEND TARGET_NAME_BASE "-mt")
        elseif(USE_THREADS AND USE_OPENMP)
            string(APPEND TARGET_NAME_BASE "-mt-omp")
        elseif(NOT USE_THREADS AND USE_OPENMP)
            string(APPEND TARGET_NAME_BASE "-st-omp")
        elseif(USE_PGC)
