...
static OpcodeInitializer _ENT_LET(ENT_LET, &Interpreter::InterpretNode_ENT_LET, []() {
	OpcodeDetails d;
	d.old_parameters = R"(assoc variables [code code1] [code code2] ... [code codeN])";
	d.returns = OpcodeDetails::DataType::ANY_BASIC;
...
static OpcodeInitializer _ENT_ASSIGN(ENT_ASSIGN, &Interpreter::InterpretNode_ENT_ASSIGN_and_ACCUM, []() {
	OpcodeDetails d;
	d.old_parameters = R"(assoc|string variables [number index1|string index1|list walk_path1|* new_value1] [* new_value1] [number index2|string index2|list walk_path2] [* new_value2] ...)";
...
static OpcodeInitializer _ENT_ACCUM(ENT_ACCUM, &Interpreter::InterpretNode_ENT_ASSIGN_and_ACCUM, []() {
	OpcodeDetails d;
	d.old_parameters = R"(assoc|string variables [number index1|string index1|list walk_path1] [* accum_value1] [number index2|string index2|list walk_path2] [* accum_value2] ...)";
	d.returns = OpcodeDetails::DataType::NULL_TYPE;
...
EvaluableNodeReference Interpreter::InterpretNode_ENT_ASSIGN_and_ACCUM(EvaluableNode *en, EvaluableNodeRequestedValueTypes immediate_result)
{
	...
	//keeps track of whether all new values assigned or accumulated are unique, cycle free, etc.
...
static OpcodeInitializer _ENT_ASSIGN_IF_EQUAL(ENT_ASSIGN_IF_EQUAL, &Interpreter::InterpretNode_ENT_ASSIGN_IF_EQUAL, []() {
	OpcodeDetails d;
	d.old_parameters = R"(string variable * value_to_compare * value_to_assign)";
...
static OpcodeInitializer _ENT_RETRIEVE(ENT_RETRIEVE, &Interpreter::InterpretNode_ENT_RETRIEVE, []() {
	OpcodeDetails d;
	d.old_parameters = R"([string|list|assoc variables])";
	d.returns = OpcodeDetails::DataType::ANY_BASIC;
...
static OpcodeInitializer _ENT_EXISTS(ENT_EXISTS, &Interpreter::InterpretNode_ENT_EXISTS, []() {
	OpcodeDetails d;
	d.old_parameters = R"(string variable)";
	d.returns = OpcodeDetails::DataType::BOOL;
...
static OpcodeInitializer _ENT_UNASSIGN(ENT_UNASSIGN, &Interpreter::InterpretNode_ENT_UNASSIGN, []() {
	OpcodeDetails d;
	d.old_parameters = R"(string variable1 [string variable2] ... [string variableN])";
	d.returns = OpcodeDetails::DataType::BOOL;
...
static OpcodeInitializer _ENT_TARGET(ENT_TARGET, &Interpreter::InterpretNode_ENT_TARGET, []() {
	OpcodeDetails d;
	d.old_parameters = R"([number|bool stack_distance] [number|string|list walk_path])";
	d.returns = OpcodeDetails::DataType::ANY_BASIC;
...
static OpcodeInitializer _ENT_ARGS(ENT_ARGS, &Interpreter::InterpretNode_ENT_ARGS, []() {
	OpcodeDetails d;
	d.old_parameters = R"([number stack_distance])";
...
static OpcodeInitializer _ENT_SET_TYPE(ENT_SET_TYPE, &Interpreter::InterpretNode_ENT_SET_TYPE, []() {
	OpcodeDetails d;
	d.old_parameters = R"(* node [string|* type])";
	d.returns = OpcodeDetails::DataType::ANY_BASIC;
...
static OpcodeInitializer _ENT_FORMAT(ENT_FORMAT, &Interpreter::InterpretNode_ENT_FORMAT, []() {
	OpcodeDetails d;
	d.old_parameters = R"(* data string from_format string to_format [assoc from_params] [assoc to_params])";
	d.returns = OpcodeDetails::DataType::ANY_BASIC;
