...
static OpcodeInitializer _ENT_CRYPTO_SIGN(ENT_CRYPTO_SIGN, &Interpreter::InterpretNode_ENT_CRYPTO_SIGN, []() {
	...
	d.parameters = OpcodeDetails::ParameterSchema{
		OpcodeDetails::ParameterGroup({"message", OpcodeDetails::DataType::STRING}),
		OpcodeDetails::ParameterGroup({"secret_key", OpcodeDetails::DataType::STRING})
	};
...
static OpcodeInitializer _ENT_CRYPTO_SIGN_VERIFY(ENT_CRYPTO_SIGN_VERIFY, &Interpreter::InterpretNode_ENT_CRYPTO_SIGN_VERIFY, []() {
	...
	d.parameters = OpcodeDetails::ParameterSchema{
		OpcodeDetails::ParameterGroup({"message", OpcodeDetails::DataType::STRING}),
		OpcodeDetails::ParameterGroup({"public_key", OpcodeDetails::DataType::STRING}),
		OpcodeDetails::ParameterGroup({"signature", OpcodeDetails::DataType::STRING})
	};
...
static OpcodeInitializer _ENT_ENCRYPT(ENT_ENCRYPT, &Interpreter::InterpretNode_ENT_ENCRYPT, []() {
	...
	d.parameters = OpcodeDetails::ParameterSchema{
		OpcodeDetails::ParameterGroup({"message", OpcodeDetails::DataType::STRING}),
		OpcodeDetails::ParameterGroup({"key1", OpcodeDetails::DataType::STRING}),
		OpcodeDetails::ParameterGroup({"nonce", OpcodeDetails::DataType::STRING, true}),
		OpcodeDetails::ParameterGroup({"key2", OpcodeDetails::DataType::STRING, true})
	};
	d.returns = OpcodeDetails::DataType::STRING;
