...
*/
	...
	{
		"parameter" : "call_container string parent_label_name [assoc arguments] [number operation_limit] [number max_node_allocations] [number max_recursion]",
		"output" : "*",
		"new scope" : true,
