...
public:
		...
		Entity::EntityReferenceBufferReference<EntityReferenceType> *all_contained_entities = nullptr)
	{
		...
		en_assoc.SetMappedChildNode(GetStringIdFromNodeTypeFromString(ENBISI_rand_seed), &en_rand_seed);
		en_assoc.SetMappedChildNode(GetStringIdFromNodeTypeFromString(ENBISI_version), &en_version);
